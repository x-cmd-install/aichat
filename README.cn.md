...
[![x-cmd/install — aichat Code Quality Monitoring Repo Card](https://x-cmd.com/repo-card/aichat.svg?lang=zh)](https://x-cmd.com/install/aichat)
...
- **上游仓库**: <https://github.com/sigoden/aichat>
- **许可证**: Apache-2.0

## 发布

- **最新版本**: `v0.30.0` (2025-07-06)
- **最近提交**: 2026-02-23
- **Release 含资产**: 10 个

## 流行度

- **Star**: 10,462 · **Fork**: 745 · **开放 issue**: 663 · **贡献者**: 35

## 累计统计

- **发布数**: 31 · **已合并 PR**: 746 · **开放 PR**: 54 · **已关闭 issue**: 613 · **开放 issue**: 50 · **提交数**: 989
...
| last60d | 2026-07-26 | 0 | 0 | 7 | 0 | 3 | 0 |
| 90d | 2026-06-26 | 0 | 0 | 10 | 0 | 7 | 0 |
| last180d | 2026-03-28 | 0 | 0 | 25 | 0 | 16 | 0 |
| 360d | 2025-09-29 | 0 | 0 | 51 | 23 | 48 | 6 |
| last720d | 2024-10-04 | 8 | 194 | 54 | 300 | 50 | 249 |
...
aichat 的安装元数据由 [x-cmd/install](https://github.com/x-cmd/install) 索引维护——这是一份由 x-cmd 在安装时读取的精选 YAML 包列表。如果 `aichat` 缺失、过期，或安装行为有问题，欢迎在该 repo 提 issue 或 PR：

- **提交 issue**: <https://github.com/x-cmd/install/issues/new>
- **编辑包条目**: <https://github.com/x-cmd/install/edit/main/aichat.yml>（或索引实际使用的路径）

本页面的数据（card / loc / scorecard / release）由 [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) 自动采集，每日重新生成。**安装行为**（版本选择、平台差异、依赖处理）的改进应提交到上游索引。

_数据快照: `data/card/260924.yml` · 2026-09-24T04:56:04Z._
